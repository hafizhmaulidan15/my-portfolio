...
const certData = [
    { title: 'Integrated Speaking English', org: 'Language Center', date: 'Nov 2025', icon: <Globe size={16} />, color: 'text-accent-teal', bg: 'bg-accent-teal/10' },
    ...
    { title: 'Data Science & Analytics', org: 'HP LIFE', date: 'Aug 2025', icon: <ChartBar size={16} />, color: 'text-accent-teal', bg: 'bg-accent-teal/10' },
    ...
    { title: 'Advance Python', org: 'Skilvul', date: 'Jan 2025', icon: <Code size={16} />, color: 'text-accent-teal', bg: 'bg-accent-teal/10' },
    ...
    { title: 'Networking Basics', org: 'Cisco', date: 'Apr 2024', icon: <Network size={16} />, color: 'text-accent-teal', bg: 'bg-accent-teal/10' },
    ...
    { title: '7 Habits of Highly Effective', org: 'FranklinCovey', date: 'Aug 2021', icon: <Certificate size={16} />, color: 'text-accent-teal', bg: 'bg-accent-teal/10' },
