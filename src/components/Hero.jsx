            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 max-w-[1400px]">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-10 items-center">
                    ...
                    <motion.div 
                        ...
                        className="lg:col-span-6 space-y-3 sm:space-y-4 md:space-y-5"
                    >
                        <div className="inline-flex items-center gap-2 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-surface border border-border text-accent-blue text-[10px] sm:text-xs md:text-sm font-medium">
                            <Factory size={14} weight="bold" className="sm:w-[16px] sm:h-[16px]" />
                            <span className="tracking-wide">HEAD OF UNIT & PRODUCTION LEADER</span>
                        </div>

                        <div className="t-stagger" ref={staggerRef}>
                            <h1 className="t-stagger-line text-[28px] sm:text-[32px] md:text-[40px] lg:text-[48px] font-bold tracking-tighter leading-[1.1] text-foreground">
                                MUHAMMAD <br />
                                <span className="text-gradient-primary">HAFIZH</span> <span className="text-text-secondary">MAULIDAN</span>
                            </h1>

                            <p className="t-stagger-line t-stagger-line--2 text-xs sm:text-sm md:text-base text-text-secondary leading-relaxed mt-2 sm:mt-3">
                            ...
                            <p className="t-stagger-line t-stagger-line--3 text-[11px] sm:text-xs md:text-sm text-text-secondary max-w-[60ch] leading-relaxed mt-2 sm:mt-3">
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-3 pt-2">
                            <MotionLink 
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="px-6 py-3 bg-primary text-foreground text-sm font-medium rounded-lg border border-primary flex items-center gap-2 transition-all duration-200 hover:bg-primary-hover shadow-[0_0_20px_rgba(17,129,255,0.15)] hover:shadow-[0_0_30px_rgba(17,129,255,0.25)]"
                            >
                            ...
                            <MotionLink 
                                ...
                                whileHover={{ scale: 1.03 }}
                                whileTap={{ scale: 0.98 }}
                                className="px-6 py-3 bg-surface border border-border text-foreground text-sm font-medium rounded-lg flex items-center gap-2 transition-all duration-200 hover:bg-surface-hover hover:border-border-light shadow-floating"
                            >
                                View works
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-8 pt-4">
                            <div>
                    ...
                    >
                            ...
                            <GlassPanel variant="overlap" className="h-full flex flex-col gap-2 sm:gap-3 md:gap-4 p-4 sm:p-5 md:p-6 lg:p-7">
                                <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
                                    <div className="p-2 sm:p-2.5 md:p-3 bg-primary/10 rounded-sm text-primary">
                                        <Factory size={18} weight="duotone" className="sm:w-[20px] sm:h-[20px] md:w-[24px] md:h-[24px]" />
                                    </div>
                                ...
                                <h2 className="text-xs sm:text-sm md:text-base font-semibold text-foreground group-hover:text-primary transition-colors">Production Leadership</h2>
                        ...
                        <Link to="/skills" className="group block w-full">
                            <GlassPanel variant="overlap" className="h-full flex flex-col gap-2 sm:gap-3 md:gap-4 p-4 sm:p-5 md:p-6 lg:p-7">
                                <div className="p-2 sm:p-2.5 md:p-3 bg-accent-blue/10 rounded-sm text-accent-blue w-fit">
                                    <ChartBar size={18} weight="duotone" className="sm:w-[20px] sm:h-[20px] md:w-[24px] md:h-[24px]" />
                                </div>
                        ...
                        <Link to="/certifications" className="group block w-full sm:col-span-2 sm:justify-self-center sm:max-w-md">
                            <GlassPanel variant="overlap" className="flex flex-col gap-2 sm:gap-3 md:gap-4 p-4 sm:p-5 md:p-6 lg:p-7">
                                <div className="p-2 sm:p-2.5 md:p-3 bg-accent-blue/10 rounded-sm text-accent-blue w-fit">
                                    <Lightning size={18} weight="duotone" className="sm:w-[20px] sm:h-[20px] md:w-[24px] md:h-[24px]" />
                                </div>
