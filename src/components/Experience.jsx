        ...
        <section id="experience" className="py-24 md:py-32 bg-background border-t border-border relative overflow-hidden">
            <div className="container mx-auto px-6 lg:px-8 max-w-[1400px]">
                ...
                <div className="max-w-[720px] mb-12">
                    ...
                    <h2 className="mt-3 font-display text-[36px] md:text-[48px] font-[800] tracking-[-0.04em] leading-[0.9] text-balance">From line to lab,<br /><span className="font-[300] italic text-text-tertiary">built to scale.</span></h2>
                </div>
