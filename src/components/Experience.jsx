...
const experiences = [
    {
        ...
        description: 'Established the Tasikmalaya unit from the ground up  built the core team, defined operational standards, and aligned cross-functional workflows. Focused on creating repeatable systems for SOPs, supplier coordination, and cold-chain execution, enabling the unit to run end-to-end with clear ownership and continuous improvement.',
        metrics: [{ v: '1', l: 'unit built' }, { v: '12', l: 'SOPs live' }, { v: '3', l: 'cities served' }],
        tags: ['Team Building', 'SOP Design', 'Operations', 'Supply Chain', 'Leadership'],
    },
    {
