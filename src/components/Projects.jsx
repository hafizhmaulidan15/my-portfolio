    ...
    const featured = [
        {
            ...
            description: 'Perjalanan produksi mozzarella dari nol hingga siap jual  1.5 bulan intensif. Batch MZ-160626-01 jadi tolok ukur: 500L susu TS 11.8% → 42.2kg avg / 211 pcs avg (422 total) @200gr, yield 10%, reject 0, tekstur elastis.',
